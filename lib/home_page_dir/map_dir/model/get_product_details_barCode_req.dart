...
class GetProductDetailsByBarCodeReq {
  bool? success;
  String? message;
  List<GetProductDetailsByBarCodeReqData>? data;
  int? statusCode;

  GetProductDetailsByBarCodeReq({
    this.success,
    this.message,
    this.data,
    this.statusCode,
  ...
  GetProductDetailsByBarCodeReq.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    message = json['message'];
    if (json['data'] != null) {
      data = <GetProductDetailsByBarCodeReqData>[];
      json['data'].forEach((v) {
        data!.add(GetProductDetailsByBarCodeReqData.fromJson(v));
      });
    }
...
class GetProductDetailsByBarCodeReqData {
  String? itemCode;
  ...
  GetProductDetailsByBarCodeReqData({
    this.itemCode,
    this.vendorMasters,
    this.itemName,
    this.price,
  ...
  GetProductDetailsByBarCodeReqData.fromJson(Map<String, dynamic> json) {
